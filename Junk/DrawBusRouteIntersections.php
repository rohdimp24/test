<html>
  ...
  <!-- <script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAA1c1sWAqiVfYVo2H2uZO3DRSdbZxIVjTSMKDiD-iCCeLYxJJn_BTfNn4DtNyckPujCTOcXysH3Glq9g"
   ...
   <script type="text/javascript" src="Scripts/drawbusRouteIntersections.js"></script>

  </head>
  <div>
	<form>
		<input type="text" id="startBusNumber" />
		<input type="text" id="endBusNumber" />
		<input type="submit" id="submit" onClick="getInsectionBusPointsToDraw();return false;"/>
		<!--<input type="button" value="Save Waypoints" onClick="saveWayPoints()">
		<input type="text" id="waypoints" size='200' />
		-->
		<input type="text" id="firstBusDetails" size='200' />
		<input type="text" id="secondBusDetails" size='200' />
